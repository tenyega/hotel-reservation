...
class ReservationController extends AbstractController
{
     ...
     */
    public function confirmation($roomNo, SessionService $sessionService, EntityManagerInterface $em, CustomerRepository $customerRepository, PaymentRepository $paymentRepository)
    {
        ...
        $payment = $paymentRepository->find('273');
        /** @var Room */
